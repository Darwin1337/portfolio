// blob animation with threejs
// taken from CodePen Blob Experiment by Victor Vergara (https://codepen.io/vcomics/pen/ZwNgvX)
...
const primitiveElement = function () {
  ...
  let geo = new THREE.IcosahedronBufferGeometry(2, 6);
  let wir = new THREE.IcosahedronBufferGeometry(2.3, 2);
